...
### Productivity:
- [One Tab](https://chrome.google.com/webstore/detail/onetab/chphlpgkkbolifaimnlloiipkdnihall). Собирает вкладки в одну, в результате чего их становится не только удобнее хранить, но и нагрузка на систему от браузера снижается. При помощи этого расширения можно формировать списки кандидатов из ссылок на их профайлы и в пару кликов высылать на ревью заинтересованным лицам (вместо множества копипастов и потерянного времени на рутинные действия)
