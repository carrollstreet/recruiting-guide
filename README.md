...
<a id='intake'></a>
## Снятие заявки
Старт работы по позиции начинается с получения заявки на вакансию (может быть в форме письма и/или заполненного документа). После этого необходимо провести встречу с нанимающей командой для уточнения всех деталей связанных с проектом/командой и поиском, чтобы сформировать профиль кандидата.  Обычно для этого используют готовый чек-лист с вопросами, например такая [форма для снятия заявки](https://drive.google.com/file/d/1YQDQNdWLylDZR3KxPbknymA7sdDq3iXY/view?usp=sharing).
