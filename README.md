...
2. После того, как были найдены сообщества, можно (используя `Namechk`):
     ...
     - Поиск в чате активных пользователей, которые отвечают на вопросы, участвуют в дискуссиях в данный момент. Следует учитывать, что это могут быть очень опытные специалисты.
      - Поиск кандидатов в чате по используемым ими ключевым словам. Это могут быть ключевые слова, которые наиболее характерны для данной профессиональной среды. Например "баланс" и/или "экономика" для гейм-дизайнеров (самый эффективный на мой взгляд).
